<template>
    <div :class="[`absolute w-[90%] lg:max-w-xl mt-10 -translate-x-1/2 left-1/2 ${getHistory ? 'lg:-translate-x-full ' : ''} bottom-12 lg:bottom-32 space-y-5 lg:space-y-0 lg:space-x-5`]">
            <section
...
const getHistory = JSON.parse(localStorage.getItem('locationHistory'));
</script>