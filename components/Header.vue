<template>
    <div class="flex items-center justify-between mt-3 mb-7">
        <button title="return to home" aria-label="return to home" @click="returnToHome()" :class="[`p-2 ml-2 rounded-full bg-grad-card-perso opacity-80 ${!useDeferredPrompt().value ? 'no-tap-highlighting' : ''}`]">
